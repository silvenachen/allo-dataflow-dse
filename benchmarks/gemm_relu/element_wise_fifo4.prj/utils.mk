...
COMMON_REPO ?= $(shell bash -c 'export MK_PATH=$(MK_PATH); echo $${MK_PATH%/export/hdd/scratch/sli3079/allo_ls/allo_ls_dse/benchmarks/gemm_relu/*}')
...
ifeq ($(TARGET),$(filter $(TARGET),sw_emu hw_emu))
	...
	$(ECHO) '$(EXECUTABLE) gemm_relu_element_wise.xclbin' >> run_app.sh
