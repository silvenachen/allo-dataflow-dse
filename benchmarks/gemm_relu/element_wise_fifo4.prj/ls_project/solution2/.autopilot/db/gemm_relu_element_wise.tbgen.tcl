set moduleName gemm_relu_element_wise
set isTopModule 1
...
set C_modelName {gemm_relu_element_wise}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 512 regular {axi_master 0}  }
	{ gmem1 int 512 regular {axi_master 0}  }
	{ gmem2 int 512 regular {axi_master 1}  }
	{ v35 int 64 regular {axi_slave 0}  }
	{ v36 int 64 regular {axi_slave 0}  }
	{ v37 int 64 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "v35","offset": { "type": "dynamic","port_name": "v35","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "v36","offset": { "type": "dynamic","port_name": "v36","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "v37","offset": { "type": "dynamic","port_name": "v37","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "v35", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	{ "Name" : "v36", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
 	{ "Name" : "v37", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":51}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"gemm_relu_element_wise","role":"start","value":"0","valid_bit":"0"},{"name":"gemm_relu_element_wise","role":"continue","value":"0","valid_bit":"4"},{"name":"gemm_relu_element_wise","role":"auto_start","value":"0","valid_bit":"7"},{"name":"v35","role":"data","value":"16"},{"name":"v36","role":"data","value":"28"},{"name":"v37","role":"data","value":"40"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"gemm_relu_element_wise","role":"start","value":"0","valid_bit":"0"},{"name":"gemm_relu_element_wise","role":"done","value":"0","valid_bit":"1"},{"name":"gemm_relu_element_wise","role":"idle","value":"0","valid_bit":"2"},{"name":"gemm_relu_element_wise","role":"ready","value":"0","valid_bit":"3"},{"name":"gemm_relu_element_wise","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8", "9", "12", "15", "19", "22", "25", "26", "27"],
		"CDFG" : "gemm_relu_element_wise",
		"Protocol" : "ap_ctrl_chain",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "Dataflow", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "1",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "532637", "EstimateLatencyMax" : "532637",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "1",
		...
		"Port" : [
			...
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "22", "SubInstance" : "store_res2_1_U0", "Port" : "gmem2"}]},
	...
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.load_buf0_1_U0", "Parent" : "0", "Child" : ["10"],
		...
		"Port" : [
			...
			{"Name" : "v20", "Type" : "None", "Direction" : "I"},
			{"Name" : "v21", "Type" : "Memory", "Direction" : "O", "DependentProc" : "15", "DependentChan" : "1",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_load_buf0_1_Pipeline_l_S_load_buf0_load_buf0_l_0_l_load_buf0_l_1_fu_51", "Port" : "v21", "Inst_start_state" : "71", "Inst_end_state" : "72"}]}]},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.load_buf0_1_U0.grp_load_buf0_1_Pipeline_l_S_load_buf0_load_buf0_l_0_l_load_buf0_l_1_fu_51", "Parent" : "9", "Child" : ["11"],
		...
		"Port" : [
			...
			{"Name" : "v21", "Type" : "Memory", "Direction" : "O"}],
		"Loop" : [
	...
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.load_buf1_1_U0", "Parent" : "0", "Child" : ["13"],
		...
		"Port" : [
			...
			{"Name" : "v26", "Type" : "Memory", "Direction" : "O", "DependentProc" : "15", "DependentChan" : "2",
				"SubConnect" : [
					{"ID" : "13", "SubInstance" : "grp_load_buf1_1_Pipeline_l_S_load_buf1_load_buf1_l_0_l_load_buf1_l_1_fu_51", "Port" : "v26", "Inst_start_state" : "71", "Inst_end_state" : "72"}]}]},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.load_buf1_1_U0.grp_load_buf1_1_Pipeline_l_S_load_buf1_load_buf1_l_0_l_load_buf1_l_1_fu_51", "Parent" : "12", "Child" : ["14"],
		...
		"Port" : [
			...
			{"Name" : "v26", "Type" : "Memory", "Direction" : "O"}],
		"Loop" : [
	...
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.gemm_stage_0_1_U0", "Parent" : "0", "Child" : ["16", "17", "18"],
		"CDFG" : "gemm_stage_0_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "v411", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "19", "DependentChan" : "26", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "v411_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "l_S_i_0_i_l_S_j_0_j_l_S_k_0_k", "PipelineType" : "UPC",
	...
	{"ID" : "16", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.gemm_stage_0_1_U0.fadd_32ns_32ns_32_3_no_dsp_1_U14", "Parent" : "15"},
	{"ID" : "17", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.gemm_stage_0_1_U0.fmul_32ns_32ns_32_2_max_dsp_1_U15", "Parent" : "15"},
	{"ID" : "18", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.gemm_stage_0_1_U0.flow_control_loop_pipe_U", "Parent" : "15"},
	{"ID" : "19", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.relu_stage_0_1_U0", "Parent" : "0", "Child" : ["20", "21"],
		"CDFG" : "relu_stage_0_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "v13", "Type" : "Memory", "Direction" : "O", "DependentProc" : "22", "DependentChan" : "3"},
			{"Name" : "v411", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "15", "DependentChan" : "26", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "v411_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "l_S_i_0_i1_l_S_j_0_j1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter2", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "1"}}]},
	{"ID" : "20", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.relu_stage_0_1_U0.fcmp_32ns_32ns_1_2_no_dsp_1_U21", "Parent" : "19"},
	{"ID" : "21", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.relu_stage_0_1_U0.flow_control_loop_pipe_U", "Parent" : "19"},
	{"ID" : "22", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.store_res2_1_U0", "Parent" : "0", "Child" : ["23"],
		"CDFG" : "store_res2_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"HasNonBlockingOperation" : "0",
		"Port" : [
			{"Name" : "v30", "Type" : "Memory", "Direction" : "I", "DependentProc" : "19", "DependentChan" : "3",
				"SubConnect" : [
					{"ID" : "23", "SubInstance" : "grp_store_res2_1_Pipeline_l_S_store_res2_store_res2_l_0_l_store_res2_l_1_fu_54", "Port" : "v30", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem2_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem2_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "23", "SubInstance" : "grp_store_res2_1_Pipeline_l_S_store_res2_store_res2_l_0_l_store_res2_l_1_fu_54", "Port" : "gmem2", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "v31", "Type" : "None", "Direction" : "I", "DependentProc" : "8", "DependentChan" : "25", "DependentChanDepth" : "4", "DependentChanType" : "1"}]},
	{"ID" : "23", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.store_res2_1_U0.grp_store_res2_1_Pipeline_l_S_store_res2_store_res2_l_0_l_store_res2_l_1_fu_54", "Parent" : "22", "Child" : ["24"],
		...
		"Loop" : [
			{"Name" : "l_S_store_res2_store_res2_l_0_l_store_res2_l_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "24", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.store_res2_1_U0.grp_store_res2_1_Pipeline_l_S_store_res2_store_res2_l_0_l_store_res2_l_1_fu_54.flow_control_loop_pipe_sequential_init_U", "Parent" : "23"},
	{"ID" : "25", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.v37_c_channel_U", "Parent" : "0"},
	{"ID" : "26", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.v41_U", "Parent" : "0"},
	{"ID" : "27", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_relu_stage_0_1_U0_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	...
	load_buf0_1 {
		...
		v21 {Type O LastRead -1 FirstWrite 2}}
	...
	load_buf1_1 {
		...
		v26 {Type O LastRead -1 FirstWrite 2}}
	...
	gemm_stage_0_1 {
		...
		v411 {Type O LastRead -1 FirstWrite 6}}
	relu_stage_0_1 {
		v13 {Type O LastRead -1 FirstWrite 2}
		v411 {Type I LastRead 1 FirstWrite -1}}
	store_res2_1 {
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "532637", "Max" : "532637"}
	, {"Name" : "Interval", "Min" : "524295", "Max" : "524295"}
]}
