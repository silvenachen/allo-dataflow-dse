...
set ID 31
set hasByteEnable 0
set MemName gemm_relu_element_wise_buf0_memcore
...
set MemName gemm_relu_element_wise_buf0
...
# FIFO definition: 
set ID 32
set FifoName gemm_relu_element_wise_fifo_w64_d4_S
set InstName v37_c_channel_U
...
# FIFO definition: 
set ID 33
set FifoName gemm_relu_element_wise_fifo_w32_d4_S
set InstName v41_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
...
# FIFO definition: 
set ID 34
set FifoName gemm_relu_element_wise_start_for_relu_stage_0_1_U0
set InstName start_for_relu_stage_0_1_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 2
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 35 \
			corename gemm_relu_element_wise_control_axilite \
			name gemm_relu_element_wise_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler gemm_relu_element_wise_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    is_flushable 0 \ 
    mem_style block \ 
    name {gemm_relu_element_wise_gmem0_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler gemm_relu_element_wise_gmem0_m_axi BINDTYPE interface TYPE interface_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    is_flushable 0 \ 
    mem_style block \ 
    name {gemm_relu_element_wise_gmem1_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler gemm_relu_element_wise_gmem1_m_axi BINDTYPE interface TYPE interface_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    is_flushable 0 \ 
    mem_style block \ 
    name {gemm_relu_element_wise_gmem2_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler gemm_relu_element_wise_gmem2_m_axi BINDTYPE interface TYPE interface_m_axi
}
