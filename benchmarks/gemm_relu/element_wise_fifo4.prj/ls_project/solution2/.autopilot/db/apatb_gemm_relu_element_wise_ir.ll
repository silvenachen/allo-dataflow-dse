; ModuleID = '/export/hdd/scratch/sli3079/allo_ls/allo_ls_dse/benchmarks/gemm_relu/element_wise_fifo4.prj/ls_project/solution2/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_gemm_relu_element_wise_ir(float* %v35, float* %v36, float* %v37) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_gemm_relu_element_wise_hw(float* %3, float* %4, float* %5)
...
declare void @apatb_gemm_relu_element_wise_hw(float*, float*, float*)

define void @gemm_relu_element_wise_hw_stub_wrapper(float*, float*, float*) #5 {
entry:
  ...
  call void @gemm_relu_element_wise_hw_stub(float* %6, float* %7, float* %8)
  call void @copy_in([4096 x float]* null, [4096 x float]* %3, [4096 x float]* null, [4096 x float]* %4, [4096 x float]* null, [4096 x float]* %5)
  ret void
}

declare void @gemm_relu_element_wise_hw_stub(float*, float*, float*)
