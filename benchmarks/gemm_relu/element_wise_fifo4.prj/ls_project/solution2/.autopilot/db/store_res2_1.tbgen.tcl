...
set C_modelArgList {
	{ v30 float 32 regular {array 4096 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ v30_address0 sc_out sc_lv 12 signal 0 } 
	{ v30_ce0 sc_out sc_logic 1 signal 0 } 
	{ v30_q0 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v30_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "v30", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "v30", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_res2_1_Pipeline_l_S_store_res2_store_res2_l_0_l_store_res2_l_1_fu_54", "Port" : "v30", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "v31", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "1"}]},
...
set Spec2ImplPortList { 
	v30 { ap_memory {  { v30_address0 mem_address 1 12 }  { v30_ce0 mem_ce 1 1 }  { v30_q0 mem_dout 0 32 } } }
