...
// ==============================================================
#ifndef XGEMM_RELU_ELEMENT_WISE_H
#define XGEMM_RELU_ELEMENT_WISE_H
...
#include <stddef.h>
#endif
#include "xgemm_relu_element_wise_hw.h"
...
} XGemm_relu_element_wise_Config;
#endif

typedef struct {
    u64 Control_BaseAddress;
    u32 IsReady;
} XGemm_relu_element_wise;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XGemm_relu_element_wise_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XGemm_relu_element_wise_ReadReg(BaseAddress, RegOffset) \
