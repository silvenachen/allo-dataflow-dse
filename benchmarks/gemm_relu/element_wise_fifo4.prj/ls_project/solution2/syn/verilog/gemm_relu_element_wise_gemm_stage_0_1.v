...
module gemm_relu_element_wise_gemm_stage_0_1 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [0:0] icmp_ln29_1_reg_448;
reg   [0:0] icmp_ln29_1_reg_448_pp0_iter2_reg;
...
wire   [0:0] icmp_ln29_1_fu_318_p2;
reg   [0:0] icmp_ln29_1_reg_448_pp0_iter1_reg;
...
wire   [11:0] tmp_6_cast_fu_293_p3;
...
gemm_relu_element_wise_fadd_32ns_32ns_32_3_no_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 3 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
gemm_relu_element_wise_fmul_32ns_32ns_32_2_max_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
always @ (*) begin
    if (((icmp_ln29_1_reg_448_pp0_iter2_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln29_1_reg_448_pp0_iter2_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v411_write = 1'b1;
    end else begin
        v411_write = 1'b0;
    end
...
assign add_ln29_fu_312_p2 = (select_ln25_fu_254_p3 + 7'd1);

assign add_ln31_fu_278_p2 = (tmp_cast_fu_216_p3 + zext_ln31_fu_274_p1);

assign add_ln32_fu_301_p2 = (tmp_6_cast_fu_293_p3 + zext_ln25_fu_270_p1);

assign and_ln24_fu_236_p2 = (xor_ln24_fu_224_p2 & icmp_ln29_fu_230_p2);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_done_reg == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((icmp_ln29_1_reg_448_pp0_iter2_reg == 1'd1) & (v411_full_n == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_done_reg == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((icmp_ln29_1_reg_448_pp0_iter2_reg == 1'd1) & (v411_full_n == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_done_reg == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((icmp_ln29_1_reg_448_pp0_iter2_reg == 1'd1) & (v411_full_n == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state7_pp0_stage0_iter3 = ((icmp_ln29_1_reg_448_pp0_iter2_reg == 1'd1) & (v411_full_n == 1'b0));
end
...
assign icmp_ln29_1_fu_318_p2 = ((add_ln29_fu_312_p2 == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln29_fu_230_p2 = ((ap_sig_allocacmp_k_load == 7'd64) ? 1'b1 : 1'b0);
...
assign tmp_6_cast_fu_293_p3 = {{trunc_ln32_fu_289_p1}, {6'd0}};
...
endmodule //gemm_relu_element_wise_gemm_stage_0_1
