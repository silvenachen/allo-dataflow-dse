set moduleName kernel_gemm_relu_Pipeline_l_S_i_j_k_0_k_l_i_l_j
set isTopModule 0
...
set C_modelName {kernel_gemm_relu_Pipeline_l_S_i_j_k_0_k_l_i_l_j}
set C_modelType { void 0 }
set C_modelArgList {
	{ buf0 float 32 regular {array 4096 { 1 3 } 1 1 }  }
	{ buf1 float 32 regular {array 4096 { 1 3 } 1 1 }  }
	{ C float 32 regular {array 4096 { 0 1 } 1 1 }  }
}
...
set portList { 
	...
	{ buf0_address0 sc_out sc_lv 12 signal 0 } 
	{ buf0_ce0 sc_out sc_logic 1 signal 0 } 
	{ buf0_q0 sc_in sc_lv 32 signal 0 } 
	{ buf1_address0 sc_out sc_lv 12 signal 1 } 
	{ buf1_ce0 sc_out sc_logic 1 signal 1 } 
	{ buf1_q0 sc_in sc_lv 32 signal 1 } 
...
set Spec2ImplPortList { 
	...
	C { ap_memory {  { C_address0 mem_address 1 12 }  { C_ce0 mem_ce 1 1 }  { C_we0 mem_we 1 1 }  { C_d0 mem_din 1 32 }  { C_address1 MemPortADDR2 1 12 }  { C_ce1 MemPortCE2 1 1 }  { C_q1 MemPortDOUT2 0 32 } } }
}
