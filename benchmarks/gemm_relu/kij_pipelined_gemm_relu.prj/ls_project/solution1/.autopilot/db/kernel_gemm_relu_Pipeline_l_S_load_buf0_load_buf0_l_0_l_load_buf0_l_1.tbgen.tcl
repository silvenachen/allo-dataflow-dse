set moduleName kernel_gemm_relu_Pipeline_l_S_load_buf0_load_buf0_l_0_l_load_buf0_l_1
set isTopModule 0
...
set C_modelName {kernel_gemm_relu_Pipeline_l_S_load_buf0_load_buf0_l_0_l_load_buf0_l_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 512 regular {axi_master 0}  }
	{ sext_ln59 int 58 regular  }
	{ buf0 float 32 regular {array 4096 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "v33","offset": { "type": "dynamic","port_name": "v33","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln59", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "buf0", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sext_ln59 sc_in sc_lv 58 signal 1 } 
	{ buf0_address0 sc_out sc_lv 12 signal 2 } 
	{ buf0_ce0 sc_out sc_logic 1 signal 2 } 
	{ buf0_we0 sc_out sc_logic 1 signal 2 } 
	{ buf0_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln59", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln59", "role": "default" }} , 
 	...
 	{ "name": "buf0_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buf0", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln59 { ap_none {  { sext_ln59 in_data 0 58 } } }
	buf0 { ap_memory {  { buf0_address0 mem_address 1 12 }  { buf0_ce0 mem_ce 1 1 }  { buf0_we0 mem_we 1 1 }  { buf0_d0 mem_din 1 32 } } }
}
