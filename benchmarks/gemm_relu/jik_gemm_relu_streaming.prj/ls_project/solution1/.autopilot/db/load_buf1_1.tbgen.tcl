...
set C_modelArgList {
	...
	{ v25 int 64 regular  }
	{ v26 float 32 regular {array 4096 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "v36","offset": { "type": "dynamic","port_name": "v36","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "v26", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ v25 sc_in sc_lv 64 signal 1 } 
	{ v26_address0 sc_out sc_lv 12 signal 2 } 
	{ v26_ce0 sc_out sc_logic 1 signal 2 } 
	{ v26_we0 sc_out sc_logic 1 signal 2 } 
	{ v26_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v26_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "v26", "role": "address0" }} , 
 	{ "name": "v26_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v26", "role": "ce0" }} , 
 	{ "name": "v26_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v26", "role": "we0" }} , 
 	{ "name": "v26_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v26", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "v26", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_buf1_1_Pipeline_l_S_load_buf1_load_buf1_l_0_l_load_buf1_l_1_fu_51", "Port" : "v26", "Inst_start_state" : "71", "Inst_end_state" : "72"}]}]},
...
set Spec2ImplPortList { 
	...
	v26 { ap_memory {  { v26_address0 mem_address 1 12 }  { v26_ce0 mem_ce 1 1 }  { v26_we0 mem_we 1 1 }  { v26_d0 mem_din 1 32 } } }
}
