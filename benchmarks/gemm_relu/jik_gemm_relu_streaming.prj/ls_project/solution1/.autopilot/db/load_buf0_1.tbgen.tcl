...
set C_modelArgList {
	...
	{ v20 int 64 regular  }
	{ v21 float 32 regular {array 4096 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "v35","offset": { "type": "dynamic","port_name": "v35","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "v20", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "v21", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ v20 sc_in sc_lv 64 signal 1 } 
	{ v21_address0 sc_out sc_lv 12 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v20", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v20", "role": "default" }} , 
 	{ "name": "v21_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "v21", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "v21", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_buf0_1_Pipeline_l_S_load_buf0_load_buf0_l_0_l_load_buf0_l_1_fu_51", "Port" : "v21", "Inst_start_state" : "71", "Inst_end_state" : "72"}]}]},
...
set Spec2ImplPortList { 
	...
	v20 { ap_none {  { v20 in_data 0 64 } } }
	v21 { ap_memory {  { v21_address0 mem_address 1 12 }  { v21_ce0 mem_ce 1 1 }  { v21_we0 mem_we 1 1 }  { v21_d0 mem_din 1 32 } } }
}
