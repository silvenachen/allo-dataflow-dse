...
#ifndef _gemm_relu_stream_jik_buf0_H_
#define _gemm_relu_stream_jik_buf0_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "gemm_relu_stream_jik_buf0_memcore.h"

SC_MODULE(gemm_relu_stream_jik_buf0) {
...
protected:
    ...
    gemm_relu_stream_jik_buf0_memcore* gemm_relu_stream_jik_buf0_memcore_U;
...
public:
    ~gemm_relu_stream_jik_buf0();
    SC_CTOR(gemm_relu_stream_jik_buf0) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        gemm_relu_stream_jik_buf0_memcore_U = new gemm_relu_stream_jik_buf0_memcore("gemm_relu_stream_jik_buf0_memcore_U");
        gemm_relu_stream_jik_buf0_memcore_U->clk      ( clk );
        gemm_relu_stream_jik_buf0_memcore_U->reset    ( reset );
        gemm_relu_stream_jik_buf0_memcore_U->ce0      ( i_ce0 );
        gemm_relu_stream_jik_buf0_memcore_U->we0      ( i_we0 );
        gemm_relu_stream_jik_buf0_memcore_U->address0 ( memcore_iaddr );
        gemm_relu_stream_jik_buf0_memcore_U->d0       ( i_d0 );
        gemm_relu_stream_jik_buf0_memcore_U->q0       ( i_q0 );

        gemm_relu_stream_jik_buf0_memcore_U->ce1      ( t_ce0 );
        gemm_relu_stream_jik_buf0_memcore_U->we1      ( t_we0 );
        gemm_relu_stream_jik_buf0_memcore_U->address1 ( memcore_taddr );
        gemm_relu_stream_jik_buf0_memcore_U->d1       ( t_d0 );
        gemm_relu_stream_jik_buf0_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "gemm_relu_stream_jik_buf0.trace");
            // ports
