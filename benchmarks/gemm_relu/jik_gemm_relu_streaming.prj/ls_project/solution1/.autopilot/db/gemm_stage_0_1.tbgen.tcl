...
set portList { 
	...
	{ v411_din sc_out sc_lv 32 signal 2 } 
	{ v411_full_n sc_in sc_logic 1 signal 2 } 
	{ v411_write sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v411_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v411", "role": "din" }} , 
 	{ "name": "v411_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v411", "role": "full_n" }} , 
 	{ "name": "v411_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v411", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "v411", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "v411_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "l_S_j_0_j_l_S_i_0_i_l_S_k_0_k", "PipelineType" : "UPC",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_3_no_dsp_1_U14", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	v411 { ap_fifo {  { v411_din fifo_data 1 32 }  { v411_full_n fifo_status 0 1 }  { v411_write fifo_update 1 1 } } }
}
