...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename v26 \
    op interface \
    ports { v26_address0 { O 12 vector } v26_ce0 { O 1 bit } v26_we0 { O 1 bit } v26_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'v26'"
}
}
...
set InstName gemm_relu_stream_jik_flow_control_loop_pipe_sequential_init_U
set CompName gemm_relu_stream_jik_flow_control_loop_pipe_sequential_init
