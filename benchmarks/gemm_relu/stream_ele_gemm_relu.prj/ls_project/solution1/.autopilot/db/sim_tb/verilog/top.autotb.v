...
`define AUTOTB_TVIN_gmem0  "./c.top.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1  "./c.top.autotvin_gmem1.dat"
`define AUTOTB_TVIN_v37  "./c.top.autotvin_v37.dat"
`define AUTOTB_TVIN_v38  "./c.top.autotvin_v38.dat"
`define AUTOTB_TVIN_v39  "./c.top.autotvin_v39.dat"
`define AUTOTB_TVIN_gmem0_out_wrapc  "./rtl.top.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "./rtl.top.autotvin_gmem1.dat"
`define AUTOTB_TVIN_v37_out_wrapc  "./rtl.top.autotvin_v37.dat"
`define AUTOTB_TVIN_v38_out_wrapc  "./rtl.top.autotvin_v38.dat"
`define AUTOTB_TVIN_v39_out_wrapc  "./rtl.top.autotvin_v39.dat"
`define AUTOTB_TVOUT_gmem2  "./c.top.autotvout_gmem2.dat"
`define AUTOTB_TVOUT_gmem2_out_wrapc  "./impl_rtl.top.autotvout_gmem2.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 139580;
