set SynModuleInfo {
  ...
  {SRCNAME kernel_gemm_relu_Pipeline_l_S_i_j_k_0_i_l_k MODELNAME kernel_gemm_relu_Pipeline_l_S_i_j_k_0_i_l_k RTLNAME kernel_gemm_relu_kernel_gemm_relu_Pipeline_l_S_i_j_k_0_i_l_k
    SUBMODULES {
  ...
  {SRCNAME kernel_gemm_relu MODELNAME kernel_gemm_relu RTLNAME kernel_gemm_relu IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME kernel_gemm_relu_buf1 RTLNAME kernel_gemm_relu_buf1 BINDTYPE storage TYPE ram_1wnr IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
