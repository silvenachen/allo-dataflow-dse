set SynModuleInfo {
  ...
  {SRCNAME kernel_gemm_relu_Pipeline_l_S_i_j_k_0_i_l_k_l_j MODELNAME kernel_gemm_relu_Pipeline_l_S_i_j_k_0_i_l_k_l_j RTLNAME kernel_gemm_relu_kernel_gemm_relu_Pipeline_l_S_i_j_k_0_i_l_k_l_j
    SUBMODULES {
