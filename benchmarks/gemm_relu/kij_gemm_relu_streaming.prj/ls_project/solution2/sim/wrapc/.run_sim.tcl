...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "gemm_relu_stream_kij.autotvin.dat"
	set constFileTvOut       "gemm_relu_stream_kij.autotvout.dat"
	set constFileHdlTvIn     "gemm_relu_stream_kij.autohdltvin.dat"
	set constFileHdlTvOut    "gemm_relu_stream_kij.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
