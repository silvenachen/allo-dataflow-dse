...
if {[file isfile gemm_relu_stream_kij.autotvin.dat]} {
	file delete -force gemm_relu_stream_kij.autotvin.dat
}

if {[file isfile gemm_relu_stream_kij.autotvout.dat]} {
	file delete -force gemm_relu_stream_kij.autotvout.dat
}
