...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.gemm_relu_stream_kij.autotvin_gmem0.dat"
         "c.gemm_relu_stream_kij.autotvin_gmem1.dat"
         "c.gemm_relu_stream_kij.autotvin_v37.dat"
         "c.gemm_relu_stream_kij.autotvin_v38.dat"
         "c.gemm_relu_stream_kij.autotvin_v39.dat"
         "c.gemm_relu_stream_kij.autotvout_gmem2.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.gemm_relu_stream_kij.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
