set SynModuleInfo {
  ...
  {SRCNAME kernel_gemm_relu_Pipeline_l_S_i_j_k_0_j_l_k_l_i MODELNAME kernel_gemm_relu_Pipeline_l_S_i_j_k_0_j_l_k_l_i RTLNAME kernel_gemm_relu_kernel_gemm_relu_Pipeline_l_S_i_j_k_0_j_l_k_l_i
    SUBMODULES {
