set SynModuleInfo {
  ...
  {SRCNAME kernel_gemm_relu_Pipeline_VITIS_LOOP_106_1_VITIS_LOOP_107_2 MODELNAME kernel_gemm_relu_Pipeline_VITIS_LOOP_106_1_VITIS_LOOP_107_2 RTLNAME kernel_gemm_relu_kernel_gemm_relu_Pipeline_VITIS_LOOP_106_1_VITIS_LOOP_107_2}
  {SRCNAME kernel_gemm_relu_Pipeline_l_k MODELNAME kernel_gemm_relu_Pipeline_l_k RTLNAME kernel_gemm_relu_kernel_gemm_relu_Pipeline_l_k
    SUBMODULES {
      {MODELNAME kernel_gemm_relu_fadd_32ns_32ns_32_3_no_dsp_1 RTLNAME kernel_gemm_relu_fadd_32ns_32ns_32_3_no_dsp_1 BINDTYPE op TYPE fadd IMPL fabric LATENCY 2 ALLOW_PRAGMA 1}
