; ModuleID = '/export/hdd/scratch/sli3079/allo_ls/allo_ls_dse/benchmarks/gemm_relu/row_wise_streaming.prj/ls_project/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_gemm_relu_row_wise_ir(float* %v38, float* %v39, float* %v40) local_unnamed_addr #0 {
entry:
  %malloccall = tail call i8* @malloc(i64 16384)
  %v38_copy = bitcast i8* %malloccall to [4096 x float]*
  %malloccall1 = tail call i8* @malloc(i64 16384)
  %v39_copy = bitcast i8* %malloccall1 to [4096 x float]*
  %malloccall2 = tail call i8* @malloc(i64 16384)
  %v40_copy = bitcast i8* %malloccall2 to [4096 x float]*
  %0 = bitcast float* %v38 to [4096 x float]*
  %1 = bitcast float* %v39 to [4096 x float]*
  %2 = bitcast float* %v40 to [4096 x float]*
  call fastcc void @copy_in([4096 x float]* %0, [4096 x float]* %v38_copy, [4096 x float]* %1, [4096 x float]* %v39_copy, [4096 x float]* %2, [4096 x float]* %v40_copy)
  %3 = getelementptr inbounds [4096 x float], [4096 x float]* %v38_copy, i32 0, i32 0
  %4 = getelementptr inbounds [4096 x float], [4096 x float]* %v39_copy, i32 0, i32 0
  %5 = getelementptr inbounds [4096 x float], [4096 x float]* %v40_copy, i32 0, i32 0
  call void @apatb_gemm_relu_row_wise_hw(float* %3, float* %4, float* %5)
  call fastcc void @copy_out([4096 x float]* %0, [4096 x float]* %v38_copy, [4096 x float]* %1, [4096 x float]* %v39_copy, [4096 x float]* %2, [4096 x float]* %v40_copy)
...
declare void @apatb_gemm_relu_row_wise_hw(float*, float*, float*)

define void @gemm_relu_row_wise_hw_stub_wrapper(float*, float*, float*) #5 {
entry:
  ...
  call void @gemm_relu_row_wise_hw_stub(float* %6, float* %7, float* %8)
  call void @copy_in([4096 x float]* null, [4096 x float]* %3, [4096 x float]* null, [4096 x float]* %4, [4096 x float]* null, [4096 x float]* %5)
  ret void
}

declare void @gemm_relu_row_wise_hw_stub(float*, float*, float*)
