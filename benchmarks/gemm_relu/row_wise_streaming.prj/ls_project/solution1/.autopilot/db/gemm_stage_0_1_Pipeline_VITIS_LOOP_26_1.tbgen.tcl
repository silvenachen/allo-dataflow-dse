set moduleName gemm_stage_0_1_Pipeline_VITIS_LOOP_26_1
set isTopModule 0
...
set C_modelName {gemm_stage_0.1_Pipeline_VITIS_LOOP_26_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ c_row float 32 regular {array 64 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "c_row", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	c_row { ap_memory {  { c_row_address0 mem_address 1 6 }  { c_row_ce0 mem_ce 1 1 }  { c_row_we0 mem_we 1 1 }  { c_row_d0 mem_din 1 32 } } }
}
