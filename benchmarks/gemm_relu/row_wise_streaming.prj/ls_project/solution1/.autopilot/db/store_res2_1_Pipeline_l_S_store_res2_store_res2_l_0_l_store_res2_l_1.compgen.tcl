...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename v33 \
    op interface \
    ports { v33_address0 { O 12 vector } v33_ce0 { O 1 bit } v33_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'v33'"
}
}
