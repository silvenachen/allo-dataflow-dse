...
entity gemm_relu_stream_jki is
generic (
...
architecture behav of gemm_relu_stream_jki is 
...
attribute shreg_extract of ap_rst_n_inv : signal is "no";
    ...
    component gemm_relu_stream_jki_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component gemm_relu_stream_jki_load_buf0_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component gemm_relu_stream_jki_load_buf1_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component gemm_relu_stream_jki_gemm_stage_0_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component gemm_relu_stream_jki_relu_stage_0_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component gemm_relu_stream_jki_store_res2_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component gemm_relu_stream_jki_buf0 IS
    generic (
        DataWidth : INTEGER;
    ...
    component gemm_relu_stream_jki_fifo_w64_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component gemm_relu_stream_jki_fifo_w32_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component gemm_relu_stream_jki_start_for_relu_stage_0_1_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component gemm_relu_stream_jki_control_s_axi IS
    generic (
    ...
    component gemm_relu_stream_jki_gmem0_m_axi IS
    generic (
    ...
    component gemm_relu_stream_jki_gmem1_m_axi IS
    generic (
        CONSERVATIVE : INTEGER;
        USER_DW : INTEGER;
        USER_AW : INTEGER;
    ...
    component gemm_relu_stream_jki_gmem2_m_axi IS
    generic (
        CONSERVATIVE : INTEGER;
        USER_DW : INTEGER;
        USER_AW : INTEGER;
...
begin
    buf0_U : component gemm_relu_stream_jki_buf0
    generic map (
        DataWidth => 32,
        AddressRange => 4096,
        AddressWidth => 12)
    ...
    buf1_U : component gemm_relu_stream_jki_buf0
    generic map (
        DataWidth => 32,
        AddressRange => 4096,
        AddressWidth => 12)
    ...
    buf2_U : component gemm_relu_stream_jki_buf0
    generic map (
        DataWidth => 32,
        AddressRange => 4096,
        AddressWidth => 12)
    ...
    control_s_axi_U : component gemm_relu_stream_jki_control_s_axi
    generic map (
    ...
    gmem0_m_axi_U : component gemm_relu_stream_jki_gmem0_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 512,
        USER_AW => 64,
    ...
    gmem1_m_axi_U : component gemm_relu_stream_jki_gmem1_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 512,
        USER_AW => 64,
    ...
    gmem2_m_axi_U : component gemm_relu_stream_jki_gmem2_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 512,
        USER_AW => 64,
    ...
    entry_proc_U0 : component gemm_relu_stream_jki_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    load_buf0_1_U0 : component gemm_relu_stream_jki_load_buf0_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    load_buf1_1_U0 : component gemm_relu_stream_jki_load_buf1_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    gemm_stage_0_1_U0 : component gemm_relu_stream_jki_gemm_stage_0_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    relu_stage_0_1_U0 : component gemm_relu_stream_jki_relu_stage_0_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    store_res2_1_U0 : component gemm_relu_stream_jki_store_res2_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    v39_c_channel_U : component gemm_relu_stream_jki_fifo_w64_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    v43_U : component gemm_relu_stream_jki_fifo_w32_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_relu_stage_0_1_U0_U : component gemm_relu_stream_jki_start_for_relu_stage_0_1_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
