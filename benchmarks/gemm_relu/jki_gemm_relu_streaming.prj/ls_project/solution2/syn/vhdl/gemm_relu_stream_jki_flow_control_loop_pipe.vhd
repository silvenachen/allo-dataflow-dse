...
entity gemm_relu_stream_jki_flow_control_loop_pipe is
port (
    ap_clk             : in  std_logic;
    ap_rst             : in  std_logic;
...
end entity gemm_relu_stream_jki_flow_control_loop_pipe;

architecture behav of gemm_relu_stream_jki_flow_control_loop_pipe is
begin 
