...
int main(int argc, char** argv) {
    ...
    if (ifile2_size != 16384) {
      std::cerr << "Error: Invalid input file, byte number mismatch.\n";
      return 1;
    }
    std::vector<uint8_t>  source_in2(16384);
    ifile2.read(reinterpret_cast<char*>(source_in2.data()), 16384);
    ...
    OCL_CHECK(err, cl::Buffer buffer_in2(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, 16384, source_in2.data(), &err));
    ...
    ofile.write(reinterpret_cast<const char*>(source_in2.data()), 16384);
    ofile.close();
