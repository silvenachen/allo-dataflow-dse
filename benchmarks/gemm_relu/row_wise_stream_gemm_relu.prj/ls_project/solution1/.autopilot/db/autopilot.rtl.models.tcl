set SynModuleInfo {
  ...
  {SRCNAME gemm_stage_0_Pipeline_VITIS_LOOP_27_1 MODELNAME gemm_stage_0_Pipeline_VITIS_LOOP_27_1 RTLNAME top_gemm_stage_0_Pipeline_VITIS_LOOP_27_1}
  {SRCNAME gemm_stage_0_Pipeline_l_S_k_0_k MODELNAME gemm_stage_0_Pipeline_l_S_k_0_k RTLNAME top_gemm_stage_0_Pipeline_l_S_k_0_k
    SUBMODULES {
  ...
  {SRCNAME gemm_stage_0_Pipeline_VITIS_LOOP_46_2 MODELNAME gemm_stage_0_Pipeline_VITIS_LOOP_46_2 RTLNAME top_gemm_stage_0_Pipeline_VITIS_LOOP_46_2}
  {SRCNAME gemm_stage_0 MODELNAME gemm_stage_0 RTLNAME top_gemm_stage_0
    SUBMODULES {
      {MODELNAME top_gemm_stage_0_c_row RTLNAME top_gemm_stage_0_c_row BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME relu_stage_0 MODELNAME relu_stage_0 RTLNAME top_relu_stage_0
    SUBMODULES {
  ...
  {SRCNAME top MODELNAME top RTLNAME top IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME top_buf1_memcore RTLNAME top_buf1_memcore BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME top_buf1 RTLNAME top_buf1 BINDTYPE storage TYPE ram IMPL auto LATENCY 2}
      ...
      {MODELNAME top_v44_buf_data_memcore RTLNAME top_v44_buf_data_memcore BINDTYPE storage TYPE ram_1wnr IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME top_v44_buf_data RTLNAME top_v44_buf_data BINDTYPE storage TYPE ram_1wnr IMPL auto LATENCY 2}
      ...
      {MODELNAME top_start_for_relu_stage_0_U0 RTLNAME top_start_for_relu_stage_0_U0 BINDTYPE storage TYPE fifo IMPL srl LATENCY -1 ALLOW_PRAGMA 1 INSTNAME {$InstName}}
