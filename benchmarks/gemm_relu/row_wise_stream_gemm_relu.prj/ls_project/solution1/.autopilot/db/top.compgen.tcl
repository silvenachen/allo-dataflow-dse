...
set ID 45
set hasByteEnable 0
set MemName top_v44_buf_data_memcore
set CoreName ap_simcore_mem
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $MemName BINDTYPE {storage} TYPE {ram_1wnr} IMPL {auto} LATENCY 2
}


# FIFO definition: 
set ID 46
set FifoName top_fifo_w64_d4_S
...
# FIFO definition: 
set ID 47
set FifoName top_start_for_relu_stage_0_U0
set InstName start_for_relu_stage_0_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 2
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_gmem0_m_axi BINDTYPE interface TYPE interface_m_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_gmem1_m_axi BINDTYPE interface TYPE interface_m_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_gmem2_m_axi BINDTYPE interface TYPE interface_m_axi
}
