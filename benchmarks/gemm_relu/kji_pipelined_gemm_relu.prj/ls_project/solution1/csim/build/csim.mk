...
AUTOPILOT_ROOT := /tmp/sli3079-xilinx-2021.1/Vitis_HLS/2021.1
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /tmp/sli3079-xilinx-2021.1/Vitis_HLS/2021.1/tps/lnx64/gcc-6.2.0/bin
endif
...
IFLAG += -D__DSP48E2__
IFLAG += -Wno-unknown-pragmas -Wall 
IFLAG += -g
...
$(ObjDir)/kernel.o: ../../../../kernel.cpp $(ObjDir)/.dir
	...
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wall  $(IFLAG) $(DFLAG) $< -o $@ ; \
