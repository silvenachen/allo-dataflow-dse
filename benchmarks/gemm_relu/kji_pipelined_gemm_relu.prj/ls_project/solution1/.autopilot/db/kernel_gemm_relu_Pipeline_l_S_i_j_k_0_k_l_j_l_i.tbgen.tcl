set moduleName kernel_gemm_relu_Pipeline_l_S_i_j_k_0_k_l_j_l_i
set isTopModule 0
...
set C_modelName {kernel_gemm_relu_Pipeline_l_S_i_j_k_0_k_l_j_l_i}
...
set portList { 
	...
	{ buf1_address0 sc_out sc_lv 12 signal 0 } 
	{ buf1_ce0 sc_out sc_logic 1 signal 0 } 
	{ buf1_q0 sc_in sc_lv 32 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		"CDFG" : "kernel_gemm_relu_Pipeline_l_S_i_j_k_0_k_l_j_l_i",
		"Protocol" : "ap_ctrl_hs",
		...
		"Loop" : [
			{"Name" : "l_S_i_j_k_0_k_l_j_l_i", "PipelineType" : "UPC",
...
set ArgLastReadFirstWriteLatency {
	kernel_gemm_relu_Pipeline_l_S_i_j_k_0_k_l_j_l_i {
