set SynModuleInfo {
  ...
  {SRCNAME kernel_gemm_relu_Pipeline_l_S_i_j_k_0_k_l_j_l_i MODELNAME kernel_gemm_relu_Pipeline_l_S_i_j_k_0_k_l_j_l_i RTLNAME kernel_gemm_relu_kernel_gemm_relu_Pipeline_l_S_i_j_k_0_k_l_j_l_i
    SUBMODULES {
  ...
  {SRCNAME kernel_gemm_relu MODELNAME kernel_gemm_relu RTLNAME kernel_gemm_relu IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME kernel_gemm_relu_gmem_m_axi RTLNAME kernel_gemm_relu_gmem_m_axi BINDTYPE interface TYPE interface_m_axi}
    }
  }
}
