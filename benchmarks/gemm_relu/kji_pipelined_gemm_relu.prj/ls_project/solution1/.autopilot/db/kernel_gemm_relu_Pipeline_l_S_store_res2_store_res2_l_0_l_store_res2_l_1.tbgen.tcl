set moduleName kernel_gemm_relu_Pipeline_l_S_store_res2_store_res2_l_0_l_store_res2_l_1
set isTopModule 0
...
set C_modelName {kernel_gemm_relu_Pipeline_l_S_store_res2_store_res2_l_0_l_store_res2_l_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 512 regular {axi_master 1}  }
	{ sext_ln84 int 58 regular  }
	{ Y float 32 regular {array 4096 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "v33","offset": { "type": "dynamic","port_name": "v33","bundle": "control"},"direction": "READONLY"},{"cName": "v34","offset": { "type": "dynamic","port_name": "v34","bundle": "control"},"direction": "READONLY"},{"cName": "v35","offset": { "type": "dynamic","port_name": "v35","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln84", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln84 sc_in sc_lv 58 signal 1 } 
	{ Y_address0 sc_out sc_lv 12 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln84", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln84", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln84 { ap_none {  { sext_ln84 in_data 0 58 } } }
	Y { ap_memory {  { Y_address0 mem_address 1 12 }  { Y_ce0 mem_ce 1 1 }  { Y_q0 mem_dout 0 32 } } }
}
