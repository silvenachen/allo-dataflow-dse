...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buf1 \
    op interface \
    ports { buf1_address0 { O 12 vector } buf1_ce0 { O 1 bit } buf1_we0 { O 1 bit } buf1_d0 { O 32 vector } } \
} "
} else {
...
set InstName kernel_gemm_transpose_flow_control_loop_pipe_sequential_init_U
set CompName kernel_gemm_transpose_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix kernel_gemm_transpose_ \
}"
} else {
