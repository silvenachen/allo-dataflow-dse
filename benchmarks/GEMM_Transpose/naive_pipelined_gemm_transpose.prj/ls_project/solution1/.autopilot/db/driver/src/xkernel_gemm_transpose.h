...
// ==============================================================
#ifndef XKERNEL_GEMM_TRANSPOSE_H
#define XKERNEL_GEMM_TRANSPOSE_H
...
#include <stddef.h>
#endif
#include "xkernel_gemm_transpose_hw.h"
...
} XKernel_gemm_transpose_Config;
#endif

typedef struct {
    u64 Control_BaseAddress;
    u32 IsReady;
} XKernel_gemm_transpose;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XKernel_gemm_transpose_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XKernel_gemm_transpose_ReadReg(BaseAddress, RegOffset) \
