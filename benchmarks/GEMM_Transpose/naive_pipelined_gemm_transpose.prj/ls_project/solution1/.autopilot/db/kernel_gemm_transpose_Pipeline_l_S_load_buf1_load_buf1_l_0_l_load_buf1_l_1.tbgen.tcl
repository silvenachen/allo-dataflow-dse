set moduleName kernel_gemm_transpose_Pipeline_l_S_load_buf1_load_buf1_l_0_l_load_buf1_l_1
set isTopModule 0
...
set C_modelName {kernel_gemm_transpose_Pipeline_l_S_load_buf1_load_buf1_l_0_l_load_buf1_l_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "v32","offset": { "type": "dynamic","port_name": "v32","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "buf1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ buf1_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buf1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buf1", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	buf1 { ap_memory {  { buf1_address0 mem_address 1 12 }  { buf1_ce0 mem_ce 1 1 }  { buf1_we0 mem_we 1 1 }  { buf1_d0 mem_din 1 32 } } }
}
