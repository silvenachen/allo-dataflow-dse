...
// ==============================================================
#ifndef XTWO_MM_STREAM_IJK_IKJ_H
#define XTWO_MM_STREAM_IJK_IKJ_H
...
#include <stddef.h>
#endif
#include "xtwo_mm_stream_ijk_ikj_hw.h"
...
} XTwo_mm_stream_ijk_ikj_Config;
#endif

typedef struct {
    u64 Control_BaseAddress;
    u32 IsReady;
} XTwo_mm_stream_ijk_ikj;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XTwo_mm_stream_ijk_ikj_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XTwo_mm_stream_ijk_ikj_ReadReg(BaseAddress, RegOffset) \
