; ModuleID = '/export/hdd/scratch/sli3079/allo_ls/allo_ls_dse/benchmarks/2MM/ijk_ikj_streaming.prj/ls_project/solution2/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_two_mm_stream_ijk_ikj_ir(float* %v53, float* %v54, float* %v55, float* %v56) local_unnamed_addr #0 {
entry:
  %malloccall = tail call i8* @malloc(i64 16384)
  %v53_copy = bitcast i8* %malloccall to [4096 x float]*
  %malloccall1 = tail call i8* @malloc(i64 16384)
  %v54_copy = bitcast i8* %malloccall1 to [4096 x float]*
  %malloccall2 = tail call i8* @malloc(i64 16384)
  %v55_copy = bitcast i8* %malloccall2 to [4096 x float]*
  %malloccall3 = tail call i8* @malloc(i64 16384)
  %v56_copy = bitcast i8* %malloccall3 to [4096 x float]*
  %0 = bitcast float* %v53 to [4096 x float]*
  %1 = bitcast float* %v54 to [4096 x float]*
  %2 = bitcast float* %v55 to [4096 x float]*
  %3 = bitcast float* %v56 to [4096 x float]*
  call fastcc void @copy_in([4096 x float]* %0, [4096 x float]* %v53_copy, [4096 x float]* %1, [4096 x float]* %v54_copy, [4096 x float]* %2, [4096 x float]* %v55_copy, [4096 x float]* %3, [4096 x float]* %v56_copy)
  %4 = getelementptr inbounds [4096 x float], [4096 x float]* %v53_copy, i32 0, i32 0
  %5 = getelementptr inbounds [4096 x float], [4096 x float]* %v54_copy, i32 0, i32 0
  %6 = getelementptr inbounds [4096 x float], [4096 x float]* %v55_copy, i32 0, i32 0
  %7 = getelementptr inbounds [4096 x float], [4096 x float]* %v56_copy, i32 0, i32 0
  call void @apatb_two_mm_stream_ijk_ikj_hw(float* %4, float* %5, float* %6, float* %7)
  call fastcc void @copy_out([4096 x float]* %0, [4096 x float]* %v53_copy, [4096 x float]* %1, [4096 x float]* %v54_copy, [4096 x float]* %2, [4096 x float]* %v55_copy, [4096 x float]* %3, [4096 x float]* %v56_copy)
...
declare void @apatb_two_mm_stream_ijk_ikj_hw(float*, float*, float*, float*)

define void @two_mm_stream_ijk_ikj_hw_stub_wrapper(float*, float*, float*, float*) #5 {
entry:
  ...
  call void @two_mm_stream_ijk_ikj_hw_stub(float* %8, float* %9, float* %10, float* %11)
...
declare void @two_mm_stream_ijk_ikj_hw_stub(float*, float*, float*, float*)
