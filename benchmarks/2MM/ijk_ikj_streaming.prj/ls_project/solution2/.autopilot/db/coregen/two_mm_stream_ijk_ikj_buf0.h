...
#ifndef _two_mm_stream_ijk_ikj_buf0_H_
#define _two_mm_stream_ijk_ikj_buf0_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "two_mm_stream_ijk_ikj_buf0_memcore.h"

SC_MODULE(two_mm_stream_ijk_ikj_buf0) {
...
protected:
    ...
    two_mm_stream_ijk_ikj_buf0_memcore* two_mm_stream_ijk_ikj_buf0_memcore_U;
...
public:
    ~two_mm_stream_ijk_ikj_buf0();
    SC_CTOR(two_mm_stream_ijk_ikj_buf0) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        two_mm_stream_ijk_ikj_buf0_memcore_U = new two_mm_stream_ijk_ikj_buf0_memcore("two_mm_stream_ijk_ikj_buf0_memcore_U");
        two_mm_stream_ijk_ikj_buf0_memcore_U->clk      ( clk );
        two_mm_stream_ijk_ikj_buf0_memcore_U->reset    ( reset );
        two_mm_stream_ijk_ikj_buf0_memcore_U->ce0      ( i_ce0 );
        two_mm_stream_ijk_ikj_buf0_memcore_U->we0      ( i_we0 );
        two_mm_stream_ijk_ikj_buf0_memcore_U->address0 ( memcore_iaddr );
        two_mm_stream_ijk_ikj_buf0_memcore_U->d0       ( i_d0 );
        two_mm_stream_ijk_ikj_buf0_memcore_U->q0       ( i_q0 );

        two_mm_stream_ijk_ikj_buf0_memcore_U->ce1      ( t_ce0 );
        two_mm_stream_ijk_ikj_buf0_memcore_U->we1      ( t_we0 );
        two_mm_stream_ijk_ikj_buf0_memcore_U->address1 ( memcore_taddr );
        two_mm_stream_ijk_ikj_buf0_memcore_U->d1       ( t_d0 );
        two_mm_stream_ijk_ikj_buf0_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "two_mm_stream_ijk_ikj_buf0.trace");
            // ports
