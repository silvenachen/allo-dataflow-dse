...
COMMON_REPO ?= $(shell bash -c 'export MK_PATH=$(MK_PATH); echo $${MK_PATH%/export/hdd/scratch/sli3079/allo_ls/allo_ls_dse/benchmarks/2MM/*}')
...
ifeq ($(TARGET),$(filter $(TARGET),sw_emu hw_emu))
	...
	$(ECHO) '$(EXECUTABLE) two_mm_stream_ikj_ikj.xclbin' >> run_app.sh
