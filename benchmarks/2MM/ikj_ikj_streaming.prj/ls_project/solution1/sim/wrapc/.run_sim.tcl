...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "two_mm_stream_ikj_ikj.autotvin.dat"
	set constFileTvOut       "two_mm_stream_ikj_ikj.autotvout.dat"
	set constFileHdlTvIn     "two_mm_stream_ikj_ikj.autohdltvin.dat"
	set constFileHdlTvOut    "two_mm_stream_ikj_ikj.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
