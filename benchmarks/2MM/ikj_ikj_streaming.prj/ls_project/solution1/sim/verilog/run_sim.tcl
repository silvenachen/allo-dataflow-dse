...
if {[file isfile two_mm_stream_ikj_ikj.autotvin.dat]} {
	file delete -force two_mm_stream_ikj_ikj.autotvin.dat
}

if {[file isfile two_mm_stream_ikj_ikj.autotvout.dat]} {
	file delete -force two_mm_stream_ikj_ikj.autotvout.dat
}
