...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.two_mm_stream_ikj_ikj.autotvin_gmem0.dat"
         "c.two_mm_stream_ikj_ikj.autotvin_gmem1.dat"
         "c.two_mm_stream_ikj_ikj.autotvin_gmem2.dat"
         "c.two_mm_stream_ikj_ikj.autotvin_v53.dat"
         "c.two_mm_stream_ikj_ikj.autotvin_v54.dat"
         "c.two_mm_stream_ikj_ikj.autotvin_v55.dat"
         "c.two_mm_stream_ikj_ikj.autotvin_v56.dat"
         "c.two_mm_stream_ikj_ikj.autotvout_gmem3.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.two_mm_stream_ikj_ikj.autotvout_gmem3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
