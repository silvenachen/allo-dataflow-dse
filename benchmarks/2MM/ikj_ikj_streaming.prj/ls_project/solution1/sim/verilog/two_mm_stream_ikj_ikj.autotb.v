...
`define AUTOTB_DUT      two_mm_stream_ikj_ikj
`define AUTOTB_DUT_INST AESL_inst_two_mm_stream_ikj_ikj
`define AUTOTB_TOP      apatb_two_mm_stream_ikj_ikj_top
`define AUTOTB_LAT_RESULT_FILE "two_mm_stream_ikj_ikj.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "two_mm_stream_ikj_ikj.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_two_mm_stream_ikj_ikj_top
...
`define AESL_DEPTH_v53 1
`define AESL_DEPTH_v54 1
`define AESL_DEPTH_v55 1
`define AESL_DEPTH_v56 1
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_ikj_ikj.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_ikj_ikj.autotvin_gmem1.dat"
`define AUTOTB_TVIN_gmem2_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_ikj_ikj.autotvin_gmem2.dat"
`define AUTOTB_TVIN_v53_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_ikj_ikj.autotvin_v53.dat"
`define AUTOTB_TVIN_v54_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_ikj_ikj.autotvin_v54.dat"
`define AUTOTB_TVIN_v55_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_ikj_ikj.autotvin_v55.dat"
`define AUTOTB_TVIN_v56_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_ikj_ikj.autotvin_v56.dat"
`define AUTOTB_TVOUT_gmem3  "../tv/cdatafile/c.two_mm_stream_ikj_ikj.autotvout_gmem3.dat"
`define AUTOTB_TVOUT_gmem3_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_ikj_ikj.autotvout_gmem3.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 279771;
parameter LENGTH_gmem0 = 256;
parameter LENGTH_gmem1 = 256;
parameter LENGTH_gmem2 = 256;
parameter LENGTH_gmem3 = 256;
parameter LENGTH_v53 = 1;
parameter LENGTH_v54 = 1;
parameter LENGTH_v55 = 1;
parameter LENGTH_v56 = 1;
...
reg end_v53;
reg [31:0] size_v53;
reg [31:0] size_v53_backup;
reg end_v54;
reg [31:0] size_v54;
reg [31:0] size_v54_backup;
reg end_v55;
reg [31:0] size_v55;
reg [31:0] size_v55_backup;
reg end_v56;
reg [31:0] size_v56;
reg [31:0] size_v56_backup;
reg end_gmem3;
reg [31:0] size_gmem3;
...
initial begin : dump_tvout_runtime_sign_gmem3
    ...
    fp = $fopen(`AUTOTB_TVOUT_gmem3_out_wrapc, "w");
    if (fp == 0) begin
    ...
    fp = $fopen(`AUTOTB_TVOUT_gmem3_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_gmem3_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
