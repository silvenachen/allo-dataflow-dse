...
`define AUTOTB_TVIN_gmem0  "./c.two_mm_stream_ikj_ikj.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1  "./c.two_mm_stream_ikj_ikj.autotvin_gmem1.dat"
`define AUTOTB_TVIN_gmem2  "./c.two_mm_stream_ikj_ikj.autotvin_gmem2.dat"
`define AUTOTB_TVIN_v53  "./c.two_mm_stream_ikj_ikj.autotvin_v53.dat"
`define AUTOTB_TVIN_v54  "./c.two_mm_stream_ikj_ikj.autotvin_v54.dat"
`define AUTOTB_TVIN_v55  "./c.two_mm_stream_ikj_ikj.autotvin_v55.dat"
`define AUTOTB_TVIN_v56  "./c.two_mm_stream_ikj_ikj.autotvin_v56.dat"
`define AUTOTB_TVIN_gmem0_out_wrapc  "./rtl.two_mm_stream_ikj_ikj.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "./rtl.two_mm_stream_ikj_ikj.autotvin_gmem1.dat"
`define AUTOTB_TVIN_gmem2_out_wrapc  "./rtl.two_mm_stream_ikj_ikj.autotvin_gmem2.dat"
`define AUTOTB_TVIN_v53_out_wrapc  "./rtl.two_mm_stream_ikj_ikj.autotvin_v53.dat"
`define AUTOTB_TVIN_v54_out_wrapc  "./rtl.two_mm_stream_ikj_ikj.autotvin_v54.dat"
`define AUTOTB_TVIN_v55_out_wrapc  "./rtl.two_mm_stream_ikj_ikj.autotvin_v55.dat"
`define AUTOTB_TVIN_v56_out_wrapc  "./rtl.two_mm_stream_ikj_ikj.autotvin_v56.dat"
`define AUTOTB_TVOUT_gmem3  "./c.two_mm_stream_ikj_ikj.autotvout_gmem3.dat"
`define AUTOTB_TVOUT_gmem3_out_wrapc  "./impl_rtl.two_mm_stream_ikj_ikj.autotvout_gmem3.dat"
module `AUTOTB_TOP;
