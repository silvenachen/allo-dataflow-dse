...
set C_modelArgList {
	...
	{ c_row float 32 regular {array 64 { 0 1 } 1 1 }  }
}
...
set portList { 
	...
	{ c_row_address0 sc_out sc_lv 6 signal 3 } 
	{ c_row_ce0 sc_out sc_logic 1 signal 3 } 
	{ c_row_we0 sc_out sc_logic 1 signal 3 } 
	{ c_row_d0 sc_out sc_lv 32 signal 3 } 
	{ c_row_address1 sc_out sc_lv 6 signal 3 } 
	{ c_row_ce1 sc_out sc_logic 1 signal 3 } 
	{ c_row_q1 sc_in sc_lv 32 signal 3 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	c_row { ap_memory {  { c_row_address0 mem_address 1 6 }  { c_row_ce0 mem_ce 1 1 }  { c_row_we0 mem_we 1 1 }  { c_row_d0 mem_din 1 32 }  { c_row_address1 MemPortADDR2 1 6 }  { c_row_ce1 MemPortCE2 1 1 }  { c_row_q1 MemPortDOUT2 0 32 } } }
}
