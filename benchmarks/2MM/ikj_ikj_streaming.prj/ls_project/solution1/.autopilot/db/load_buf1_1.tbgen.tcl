...
set C_modelArgList {
	...
	{ v38 int 64 regular  }
	{ v39 float 32 regular {array 4096 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "v54","offset": { "type": "dynamic","port_name": "v54","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "v38", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ v38 sc_in sc_lv 64 signal 1 } 
	{ v39_address0 sc_out sc_lv 12 signal 2 } 
	{ v39_ce0 sc_out sc_logic 1 signal 2 } 
	{ v39_we0 sc_out sc_logic 1 signal 2 } 
	{ v39_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v38", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v38", "role": "default" }} , 
 	{ "name": "v39_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "v39", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "v39", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_buf1_1_Pipeline_l_S_load_buf1_load_buf1_l_0_l_load_buf1_l_1_fu_51", "Port" : "v39", "Inst_start_state" : "71", "Inst_end_state" : "72"}]}]},
...
set Spec2ImplPortList { 
	...
	v38 { ap_none {  { v38 in_data 0 64 } } }
	v39 { ap_memory {  { v39_address0 mem_address 1 12 }  { v39_ce0 mem_ce 1 1 }  { v39_we0 mem_we 1 1 }  { v39_d0 mem_din 1 32 } } }
}
