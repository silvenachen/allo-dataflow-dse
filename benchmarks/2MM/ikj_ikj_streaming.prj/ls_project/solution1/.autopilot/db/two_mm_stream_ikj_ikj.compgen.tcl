...
set ID 57
set hasByteEnable 0
set MemName two_mm_stream_ikj_ikj_buf0_memcore
...
set MemName two_mm_stream_ikj_ikj_buf0
...
# FIFO definition: 
set ID 58
set FifoName two_mm_stream_ikj_ikj_fifo_w64_d4_S
set InstName v56_c_channel_U
...
# FIFO definition: 
set ID 59
set FifoName two_mm_stream_ikj_ikj_fifo_w32_d4_S
set InstName v61_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 60 \
			corename two_mm_stream_ikj_ikj_control_axilite \
			name two_mm_stream_ikj_ikj_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler two_mm_stream_ikj_ikj_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    is_flushable 0 \ 
    mem_style block \ 
    name {two_mm_stream_ikj_ikj_gmem0_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler two_mm_stream_ikj_ikj_gmem0_m_axi BINDTYPE interface TYPE interface_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    is_flushable 0 \ 
    mem_style block \ 
    name {two_mm_stream_ikj_ikj_gmem1_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler two_mm_stream_ikj_ikj_gmem1_m_axi BINDTYPE interface TYPE interface_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    is_flushable 0 \ 
    mem_style block \ 
    name {two_mm_stream_ikj_ikj_gmem2_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler two_mm_stream_ikj_ikj_gmem2_m_axi BINDTYPE interface TYPE interface_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    is_flushable 0 \ 
    mem_style block \ 
    name {two_mm_stream_ikj_ikj_gmem3_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler two_mm_stream_ikj_ikj_gmem3_m_axi BINDTYPE interface TYPE interface_m_axi
}
