...
set C_modelArgList {
	...
	{ T_buffer float 32 regular {array 4096 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln68", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "T_buffer", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ T_buffer_address0 sc_out sc_lv 12 signal 2 } 
	{ T_buffer_ce0 sc_out sc_logic 1 signal 2 } 
	{ T_buffer_q0 sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "T_buffer_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "T_buffer", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	...
	T_buffer { ap_memory {  { T_buffer_address0 mem_address 1 12 }  { T_buffer_ce0 mem_ce 1 1 }  { T_buffer_q0 mem_dout 0 32 } } }
