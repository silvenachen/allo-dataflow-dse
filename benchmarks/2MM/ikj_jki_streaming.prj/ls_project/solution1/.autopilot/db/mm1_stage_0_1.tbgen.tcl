...
set portList { 
	...
	{ v631_din sc_out sc_lv 32 signal 2 } 
	{ v631_full_n sc_in sc_logic 1 signal 2 } 
	{ v631_write sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "4", "8"],
		...
		"Port" : [
			...
			{"Name" : "v631", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_mm1_stage_0_1_Pipeline_VITIS_LOOP_43_2_fu_67", "Port" : "v631", "Inst_start_state" : "6", "Inst_end_state" : "7"}]}],
		"Loop" : [
