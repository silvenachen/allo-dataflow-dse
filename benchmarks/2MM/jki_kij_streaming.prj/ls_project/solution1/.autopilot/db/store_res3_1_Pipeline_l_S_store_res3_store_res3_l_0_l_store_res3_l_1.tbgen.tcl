set moduleName store_res3_1_Pipeline_l_S_store_res3_store_res3_l_0_l_store_res3_l_1
set isTopModule 0
...
set C_modelName {store_res3.1_Pipeline_l_S_store_res3_store_res3_l_0_l_store_res3_l_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem3 int 512 regular {axi_master 1}  }
	{ sext_ln128 int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "v54","offset": { "type": "dynamic","port_name": "v54","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln128", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln128", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln128", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln128 { ap_none {  { sext_ln128 in_data 0 58 } } }
