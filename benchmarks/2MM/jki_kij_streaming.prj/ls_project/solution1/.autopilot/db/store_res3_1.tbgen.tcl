...
set C_modelArgList {
	{ v46 float 32 regular {array 4096 { 1 3 } 1 1 }  }
	{ gmem3 int 512 regular {axi_master 1}  }
	{ v47 int 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v46", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "v47", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ v46_address0 sc_out sc_lv 12 signal 0 } 
	{ v46_ce0 sc_out sc_logic 1 signal 0 } 
	{ v46_q0 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v46_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v46", "role": "q0" }} , 
 	...
 	{ "name": "v47", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v47", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "v46", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_res3_1_Pipeline_l_S_store_res3_store_res3_l_0_l_store_res3_l_1_fu_54", "Port" : "v46", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "v47", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "1"}]},
...
set Spec2ImplPortList { 
	v46 { ap_memory {  { v46_address0 mem_address 1 12 }  { v46_ce0 mem_ce 1 1 }  { v46_q0 mem_dout 0 32 } } }
