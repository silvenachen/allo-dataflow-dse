...
entity two_mm_stream_jki_kij_mm1_stage_0_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of two_mm_stream_jki_kij_mm1_stage_0_1 is 
...
attribute shreg_extract : string;
    ...
    signal grp_mm1_stage_0_1_Pipeline_VITIS_LOOP_40_2_fu_63_v591_din : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_mm1_stage_0_1_Pipeline_VITIS_LOOP_40_2_fu_63_v591_write : STD_LOGIC;
    ...
    component two_mm_stream_jki_kij_mm1_stage_0_1_Pipeline_VITIS_LOOP_26_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component two_mm_stream_jki_kij_mm1_stage_0_1_Pipeline_l_S_k_0_k_l_S_i_0_i IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component two_mm_stream_jki_kij_mm1_stage_0_1_Pipeline_VITIS_LOOP_40_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component two_mm_stream_jki_kij_mm1_stage_0_1_c_col IS
    generic (
        DataWidth : INTEGER;
...
begin
    c_col_U : component two_mm_stream_jki_kij_mm1_stage_0_1_c_col
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    grp_mm1_stage_0_1_Pipeline_VITIS_LOOP_26_1_fu_48 : component two_mm_stream_jki_kij_mm1_stage_0_1_Pipeline_VITIS_LOOP_26_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_mm1_stage_0_1_Pipeline_l_S_k_0_k_l_S_i_0_i_fu_53 : component two_mm_stream_jki_kij_mm1_stage_0_1_Pipeline_l_S_k_0_k_l_S_i_0_i
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_mm1_stage_0_1_Pipeline_VITIS_LOOP_40_2_fu_63 : component two_mm_stream_jki_kij_mm1_stage_0_1_Pipeline_VITIS_LOOP_40_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    v591_write_assign_proc : process(grp_mm1_stage_0_1_Pipeline_VITIS_LOOP_40_2_fu_63_v591_write, ap_CS_fsm_state7)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            v591_write <= grp_mm1_stage_0_1_Pipeline_VITIS_LOOP_40_2_fu_63_v591_write;
        else 
