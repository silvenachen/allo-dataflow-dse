...
set ID 62
set hasByteEnable 0
set MemName two_mm_stream_jki_jki_buf0_memcore
...
set MemName two_mm_stream_jki_jki_buf0
...
# FIFO definition: 
set ID 63
set FifoName two_mm_stream_jki_jki_fifo_w64_d4_S
...
# FIFO definition: 
set ID 64
set FifoName two_mm_stream_jki_jki_fifo_w32_d4_S
set InstName v61_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 65 \
			corename two_mm_stream_jki_jki_control_axilite \
			name two_mm_stream_jki_jki_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler two_mm_stream_jki_jki_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    is_flushable 0 \ 
    mem_style block \ 
    name {two_mm_stream_jki_jki_gmem0_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler two_mm_stream_jki_jki_gmem0_m_axi BINDTYPE interface TYPE interface_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    is_flushable 0 \ 
    mem_style block \ 
    name {two_mm_stream_jki_jki_gmem1_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler two_mm_stream_jki_jki_gmem1_m_axi BINDTYPE interface TYPE interface_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    is_flushable 0 \ 
    mem_style block \ 
    name {two_mm_stream_jki_jki_gmem2_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler two_mm_stream_jki_jki_gmem2_m_axi BINDTYPE interface TYPE interface_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    is_flushable 0 \ 
    mem_style block \ 
    name {two_mm_stream_jki_jki_gmem3_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler two_mm_stream_jki_jki_gmem3_m_axi BINDTYPE interface TYPE interface_m_axi
}
