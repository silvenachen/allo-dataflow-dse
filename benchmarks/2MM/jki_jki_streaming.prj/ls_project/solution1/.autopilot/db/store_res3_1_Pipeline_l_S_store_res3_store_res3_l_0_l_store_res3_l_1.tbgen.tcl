...
set C_modelArgMapList {[ 
	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "v56","offset": { "type": "dynamic","port_name": "v56","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln132", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln132 sc_in sc_lv 58 signal 1 } 
	{ v48_address0 sc_out sc_lv 12 signal 2 } 
	{ v48_ce0 sc_out sc_logic 1 signal 2 } 
	{ v48_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln132", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln132", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln132 { ap_none {  { sext_ln132 in_data 0 58 } } }
