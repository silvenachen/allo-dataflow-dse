...
set C_modelArgList {
	{ v48 float 32 regular {array 4096 { 1 3 } 1 1 }  }
	{ gmem3 int 512 regular {axi_master 1}  }
	{ v49 int 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v48", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "v49", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ v48_address0 sc_out sc_lv 12 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v48_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "v48", "role": "address0" }} , 
 	...
 	{ "name": "v49", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v49", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "v48", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_res3_1_Pipeline_l_S_store_res3_store_res3_l_0_l_store_res3_l_1_fu_54", "Port" : "v48", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "v49", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "1"}]},
...
set Spec2ImplPortList { 
	v48 { ap_memory {  { v48_address0 mem_address 1 12 }  { v48_ce0 mem_ce 1 1 }  { v48_q0 mem_dout 0 32 } } }
