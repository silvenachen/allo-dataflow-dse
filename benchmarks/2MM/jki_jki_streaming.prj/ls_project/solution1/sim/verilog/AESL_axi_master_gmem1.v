...
//------------------------Parameter----------------------
`define TV_IN_gmem1 "../tv/cdatafile/c.two_mm_stream_jki_jki.autotvin_gmem1.dat"
`define TV_OUT_gmem1 "../tv/rtldatafile/rtl.two_mm_stream_jki_jki.autotvout_gmem1.dat"
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem1_mem_depth) begin
                $display ("/export/hdd/scratch/sli3079/allo_ls/allo_ls_dse/benchmarks/2MM/jki_jki_streaming.prj/ls_project/solution1/sim/verilog/AESL_axi_master_gmem1.v: Write request address %d exceed AXI master gmem1 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem1_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem1_mem_depth) begin
                $display ("/export/hdd/scratch/sli3079/allo_ls/allo_ls_dse/benchmarks/2MM/jki_jki_streaming.prj/ls_project/solution1/sim/verilog/AESL_axi_master_gmem1.v: Read request address %d exceed AXI master gmem1 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem1_mem_depth); 
                $finish;
            end
