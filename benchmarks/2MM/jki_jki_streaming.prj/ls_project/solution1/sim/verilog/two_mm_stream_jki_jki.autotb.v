...
`define AUTOTB_DUT      two_mm_stream_jki_jki
`define AUTOTB_DUT_INST AESL_inst_two_mm_stream_jki_jki
`define AUTOTB_TOP      apatb_two_mm_stream_jki_jki_top
`define AUTOTB_LAT_RESULT_FILE "two_mm_stream_jki_jki.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "two_mm_stream_jki_jki.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_two_mm_stream_jki_jki_top
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_jki_jki.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_jki_jki.autotvin_gmem1.dat"
`define AUTOTB_TVIN_gmem2_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_jki_jki.autotvin_gmem2.dat"
`define AUTOTB_TVIN_v53_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_jki_jki.autotvin_v53.dat"
`define AUTOTB_TVIN_v54_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_jki_jki.autotvin_v54.dat"
`define AUTOTB_TVIN_v55_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_jki_jki.autotvin_v55.dat"
`define AUTOTB_TVIN_v56_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_jki_jki.autotvin_v56.dat"
`define AUTOTB_TVOUT_gmem3  "../tv/cdatafile/c.two_mm_stream_jki_jki.autotvout_gmem3.dat"
`define AUTOTB_TVOUT_gmem3_out_wrapc  "../tv/rtldatafile/rtl.two_mm_stream_jki_jki.autotvout_gmem3.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 547091;
