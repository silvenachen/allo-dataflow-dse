...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /tmp/sli3079-xilinx-2021.1/Vitis_HLS/2021.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tmp/sli3079-xilinx-2021.1/Vitis_HLS/2021.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tmp/sli3079-xilinx-2021.1/Vitis_HLS/2021.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tmp/sli3079-xilinx-2021.1/Vitis_HLS/2021.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "two_mm_stream_jki_jki.autotvin.dat"
	set constFileTvOut       "two_mm_stream_jki_jki.autotvout.dat"
	set constFileHdlTvIn     "two_mm_stream_jki_jki.autohdltvin.dat"
	set constFileHdlTvOut    "two_mm_stream_jki_jki.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
