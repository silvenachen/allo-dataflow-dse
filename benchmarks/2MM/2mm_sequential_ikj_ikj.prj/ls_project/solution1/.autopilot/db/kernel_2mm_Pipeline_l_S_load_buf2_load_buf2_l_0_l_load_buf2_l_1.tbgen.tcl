set moduleName kernel_2mm_Pipeline_l_S_load_buf2_load_buf2_l_0_l_load_buf2_l_1
set isTopModule 0
...
set C_modelName {kernel_2mm_Pipeline_l_S_load_buf2_load_buf2_l_0_l_load_buf2_l_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 512 regular {axi_master 0}  }
	{ sext_ln89 int 58 regular  }
	{ buf2 float 32 regular {array 4096 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "v44","offset": { "type": "dynamic","port_name": "v44","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln89", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "buf2", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ buf2_address0 sc_out sc_lv 12 signal 2 } 
	{ buf2_ce0 sc_out sc_logic 1 signal 2 } 
	{ buf2_we0 sc_out sc_logic 1 signal 2 } 
	{ buf2_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buf2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buf2", "role": "d0" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "kernel_2mm_Pipeline_l_S_load_buf2_load_buf2_l_0_l_load_buf2_l_1",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	kernel_2mm_Pipeline_l_S_load_buf2_load_buf2_l_0_l_load_buf2_l_1 {
		gmem2 {Type I LastRead 1 FirstWrite -1}
		sext_ln89 {Type I LastRead 0 FirstWrite -1}
		buf2 {Type O LastRead -1 FirstWrite 2}}}
...
set Spec2ImplPortList { 
	...
	buf2 { ap_memory {  { buf2_address0 mem_address 1 12 }  { buf2_ce0 mem_ce 1 1 }  { buf2_we0 mem_we 1 1 }  { buf2_d0 mem_din 1 32 } } }
}
